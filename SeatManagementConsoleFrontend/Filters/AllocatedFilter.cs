...
{
    internal class AllocatedFilter
    {
        ...
        public void applybuildingfilter()
        {
            ...
            else
            {
                ...
                {
                    var reports = report.Allocatedreport().Where(r => r.BuildingAbbreviation == buildingtofilter.BuildingAbbreviation);
        ...
        public void applyFloorFilter(int Buildingid)
        {
            ...
            else
            {
                ...
                {
                    var reports = report.Allocatedreport().Where(r => r.Floor == floorInput);
                    output.AllocatedReportConsoleOutput(reports.ToList());
        ...
        public void applyfacilityFilter(int floorInput)
        {
            ...
            else
            {
                ...
                //else if (input == 2)
                //{
                var reports = report.Allocatedreport().Where(r => r.FacilityName == facilityInput);
                output.AllocatedReportConsoleOutput(reports.ToList());
                //}
                //else
                //{
